...
#include "../dglib/include/DgInAIGenFile.h"
#include "../dglib/include/DgInShapefile.h"
#include "../dglib/include/DgOutShapefile.h"
...
#include "../dglib/include/DgLocList.h"
#include "../dglib/include/DgDmdD4Grid2D.h"
#include "../dglib/include/DgDmdD4Grid2DS.h"
#include "../dglib/include/DgTriGrid2D.h"
#include "../dglib/include/DgOutRandPtsText.h"
#include "DgHexSF.h"

////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
GridGenParam::GridGenParam (DgParamList& plist)
      : MainParam(plist), wholeEarth (true), seqToPoly(false), clipAIGen (true),
...
void doGridGen (GridGenParam& dp, DgGridPList& plist)
{
   for (dp.curGrid = 1; dp.curGrid <= dp.numGrids; dp.curGrid++)
   {
      ...
      if (dp.numGrids > 1) 
      {
         ...
         dp.metaOutFileName = dp.metaOutFileName + suffix; dp.cellOutFileName = dp.cellOutFileName + suffix; dp.ptOutFileName = dp.ptOutFileName + suffix;
